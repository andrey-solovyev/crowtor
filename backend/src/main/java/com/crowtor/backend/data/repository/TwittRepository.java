...
public interface TwittRepository extends JpaRepository<Twitt,Long> {
    ...
    @Query(value = "select new com.crowtor.backend.data.dto.TwittFeedDto" +
            "(t.id,t.textTwit,t.isPremium,t.personLikes.size,t.personDisLikes.size,t.created,t.author.nickName,t.author.firstName,t.author.lastName,t.originalTwittId)" +
            " from Twitt t where t.isDeleted= false and t.isModerate=true order by t.created")
    ...
    @Query(value = "select new com.crowtor.backend.data.dto.TwittFeedDto" +
            ...
            "(case when :person = li then true else false end),(case when :person = dis then true else false end),t.originalTwittId)" +
            " from Twitt t join t.personLikes li join t.personDisLikes dis  where t.isDeleted= false and t.isModerate=true order by t.created")
    ...
    @Query("select new com.crowtor.backend.data.dto.TwittFeedDto" +
            "(t.id,t.textTwit,t.isPremium,t.personLikes.size,t.personDisLikes.size,t.created,t.author.nickName,t.author.firstName,t.author.lastName," +
            "(case when :personId in (t.personLikes) then true else false end),(case when :personId in (t.personDisLikes) then true else false end),t.originalTwittId)" +
            " from Twitt t where t.author in :person and t.isDeleted= false and t.isModerate=true " +
            " order by t.created")
    List<TwittFeedDto> findAllBySubscription(@Param("person")Set<Person> person,@Param("personId") long personId);

    @Query(value = "select new com.crowtor.backend.data.dto.TwittFeedDto" +
            "(t.id,t.textTwit,t.isPremium,t.personLikes.size,t.personDisLikes.size,t.created,t.author.nickName,t.author.firstName,t.author.lastName," +
            "(case when :current = li then true else false end),(case when :current = dis then true else false end),t.originalTwittId)" +
            " from Twitt t join t.personLikes li join t.personDisLikes dis where t.author.id=:personId and t.isDeleted= false and t.isModerate=true order by t.created")
    ...
    @Query("select new com.crowtor.backend.data.dto.TwittFeedDto" +
            "(t.id,t.textTwit,t.isPremium,t.personLikes.size,t.personDisLikes.size,t.created,t.author.nickName,t.author.firstName,t.author.lastName,t.originalTwittId)" +
            " from Twitt t where t.author.id=:personId and t.isDeleted= false and t.isModerate=true")
    Set<TwittFeedDto> findAllTwittsFromUser(Long personId);

    @Query("select new com.crowtor.backend.data.dto.TwittFeedDto" +
            "(t.id,t.textTwit,t.isPremium,t.personLikes.size,t.personDisLikes.size,t.created,t.author.nickName,t.author.firstName,t.author.lastName,t.originalTwittId)" +
            " from Twitt t where  t.isDeleted= false and t.isModerate=true")
